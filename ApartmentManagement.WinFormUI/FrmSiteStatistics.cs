#nullable disable
// FrmSiteStatistics.cs
// Site İstatistikleri - SiteManager için detaylı istatistik dashboard'u
...
namespace ApartmentManagement.WinFormUI
{
    ...
    /// Site İstatistikleri - SiteManager için detaylı istatistik dashboard'u
    /// </summary>
    public partial class FrmSiteStatistics : DevExpress.XtraEditors.XtraForm
    {
        ...
        /// <summary>
        /// FrmSiteStatistics constructor
        /// </summary>
        public FrmSiteStatistics(User user)
        {
            _currentUser = user;
        ...
        private void InitializeComponent()
        {
            ...
            lblTitle.Text = "📊 Site İstatistikleri";
            ...
            lblSite.Text = "Site Seçiniz:";
            lblSite.Appearance.Font = new Font("Tahoma", 9F);
            lblSite.Location = new Point(leftMargin + 250, currentY + 5);
            this.Controls.Add(lblSite);

            cmbSite = new ComboBoxEdit();
            cmbSite.Location = new Point(leftMargin + 350, currentY);
            cmbSite.Size = new Size(250, 30);
            cmbSite.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
            cmbSite.Properties.Appearance.Font = new Font("Tahoma", 9F);
            cmbSite.SelectedIndexChanged += CmbSite_SelectedIndexChanged;
            this.Controls.Add(cmbSite);
        ...
        private void LoadSites()
        {
            ...
            if (cmbSite.Properties.Items.Count > 0)
            {
                ...
                _currentSite = sites.FirstOrDefault();
            }
        }
        ...
        {
            if (cmbSite?.SelectedItem == null) return;

            var siteName = cmbSite.SelectedItem.ToString();
            var sites = _siteService.GetAll();
            _currentSite = sites.FirstOrDefault(s => s.Name == siteName);
            LoadData();
        }
        ...
        private void LoadData()
        {
            ...
            {
                // Genel İstatistikler
                var blocks = _blockService.GetAllBySiteId(_currentSite.Id);
                var apartments = new List<Apartment>();
                foreach (var block in blocks)
                {
                    apartments.AddRange(_apartmentService.GetAllByBlockId(block.Id));
                }

                var flats = new List<Flat>();
                foreach (var apartment in apartments)
                {
                    flats.AddRange(_flatService.GetAllByApartmentId(apartment.Id));
                }
                ...
                // Aidat Özeti
                var allDues = new List<Dues>();
                foreach (var apartment in apartments)
                {
                    allDues.AddRange(_duesService.GetByApartmentId(apartment.Id));
                }
                ...
                // Gider Özeti
                var expenses = _expenseService.GetBySiteId(_currentSite.Id);
                ...
                // Flat bilgilerini ekle (memory'de işle)
                var recentDuesWithFlat = recentDues.Select(d =>
                {
                    var flat = flats.FirstOrDefault(f => f.Id == d.FlatId);
                    var apartment = flat != null ? apartments.FirstOrDefault(a => a.Id == flat.ApartmentId) : null;
                    
                    return new
                    {
                        d.Id,
                        Apartman = apartment?.Name ?? "-",
                        Daire = flat?.DoorNumber.ToString() ?? "-",
        ...
        private void ConfigureDuesColumns()
        {
            ...
            int visibleIndex = 0;
            if (gvRecentDues.Columns["Apartman"] != null)
            {
                gvRecentDues.Columns["Apartman"].VisibleIndex = visibleIndex++;
                gvRecentDues.Columns["Apartman"].Caption = "Apartman";
                gvRecentDues.Columns["Apartman"].Width = 150;
            }
            if (gvRecentDues.Columns["Daire"] != null)
            {
                ...
                gvRecentDues.Columns["Daire"].Width = 100;
            }
            if (gvRecentDues.Columns["Tutar"] != null)
            {
                ...
                gvRecentDues.Columns["Tutar"].Width = 120;
            ...
            if (gvRecentDues.Columns["Ay"] != null)
            {
                ...
                gvRecentDues.Columns["Ay"].Width = 100;
            }
            if (gvRecentDues.Columns["Durum"] != null)
            {
                ...
                gvRecentDues.Columns["Durum"].Width = 100;
            }
        }
        ...
        private void ConfigureExpensesColumns()
        {
            ...
            if (gvRecentExpenses.Columns["Aciklama"] != null)
            {
                ...
                gvRecentExpenses.Columns["Aciklama"].Width = 250;
            }
            ...
            if (gvRecentExpenses.Columns["Tutar"] != null)
            {
                ...
                gvRecentExpenses.Columns["Tutar"].Width = 120;
